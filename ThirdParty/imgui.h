...
//                 Begin_Render ImGuiPlatformIO's Monitors list every frame.
//                 Begin_Render MousePos every frame, in absolute coordinates.
// - Application:  In your main loop, call ImGui::UpdatePlatformWindows(), ImGui::RenderPlatformWindowsDefault() after EndFrame() or Render().
...
struct ImGuiPlatformIO
{
    ...
    // - Updated by: app/backend. Begin_Render every frame to dynamically support changing monitor or DPI configuration.
