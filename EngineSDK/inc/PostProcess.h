...
typedef struct tagPostProcessParam
{
    ...
    _float4 vFogParams = { 20.f, 80.f, 0.03f, 0.f }; // x=start, y=end, z=density, w=enable

    _float4 vVignetteParams = { 0.5f, 2.f, 1.f, 0.f }; // x=intensity, y=power, z=roundness, w=enable
