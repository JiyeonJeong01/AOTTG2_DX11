...
void CAsset_Registry::Register_Builtin_Asset()
{
    ...
    Register_Builtin_Inner(DEFAULT_ASSET_GUID::MESH_CUBE_TEX, ASSET_TYPE::MESH);
    Register_Builtin_Inner(DEFAULT_ASSET_GUID::MESH_CUBE_NOR_TEX, ASSET_TYPE::MESH);

    Register_Builtin_Inner(DEFAULT_ASSET_GUID::MATERIAL_UI_DEFAULT, ASSET_TYPE::MATERIAL);
    Register_Builtin_Inner(DEFAULT_ASSET_GUID::MATERIAL_VTXTEX, ASSET_TYPE::MATERIAL);
