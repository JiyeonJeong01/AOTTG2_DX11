...
void CScoutBehavior_RequestResupply::Set_SpecialCamera(CGameObject* pCameraObject)
{
...
void CScoutBehavior_RequestResupply::Set_UI(CGameObject* pDialogue, CGameObject* pFade)
{
...
void CScoutBehavior_RequestResupply::Update_Fade(_float fDT)
{
    ...
    {
        _float4 vColor = { 1.f, 1.f, 1.f, m_fFadeAlpha };
        m_crFadeUI.Set_Color(vColor);
    }
