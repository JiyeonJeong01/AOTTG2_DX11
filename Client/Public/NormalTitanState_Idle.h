...
class CNormalTitanState_Idle final : public CTitanState
{
public:
    CNormalTitanState_Idle(Engine::CGameObject* goTitan, CTitan* scTitan, TITAN_STATE eState);
    ~CNormalTitanState_Idle();
...
public:
    static std::shared_ptr<CNormalTitanState_Idle> Create(
