...
class CNormalTitanState_Stunned final : public CTitanState
{
public:
    CNormalTitanState_Stunned(Engine::CGameObject* goTitan, CTitan* scTitan, TITAN_STATE eState);
    ~CNormalTitanState_Stunned();
