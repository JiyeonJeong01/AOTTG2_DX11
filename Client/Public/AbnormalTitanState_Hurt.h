...
class CAbnormalTitanState_Hurt final : public CTitanState
{
public:
    CAbnormalTitanState_Hurt(Engine::CGameObject* goTitan, CTitan* scTitan, TITAN_STATE eState);
    ~CAbnormalTitanState_Hurt();
...
public:
    static std::shared_ptr<CAbnormalTitanState_Hurt> Create(Engine::CGameObject* goTitan, CTitan* scTitan, TITAN_STATE eState);
};
