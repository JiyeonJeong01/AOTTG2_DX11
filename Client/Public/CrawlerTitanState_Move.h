...
class CCrawlerTitanState_Move final : public CTitanState
{
public:
    CCrawlerTitanState_Move(Engine::CGameObject* goTitan, CTitan* scTitan, TITAN_STATE eState);
    ~CCrawlerTitanState_Move();
...
public:
    static std::shared_ptr<CCrawlerTitanState_Move> Create(
